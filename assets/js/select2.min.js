...
jQuery( document ).ready( function( $ ) {
	$( 'select.wbcom-demo-exporter-select2' ).select2();
});
...
jQuery( document ).ready( function( $ ) {
	...
	$( '.wbcom_demo_exporter-upload-button' ).click( function( event ) {
	    ...
	    wbcom_demo_exporter_mediaUploader.on( 'select', function() {
	    	...
	    	wbcom_demo_exporter_thisRef.siblings( '.wbcom_demo_exporter_img_url' ).val( attachment.url );
	    	wbcom_demo_exporter_thisRef.siblings( '.wbcom_demo_exporter_img').attr( 'src', attachment.url );
	    	wbcom_demo_exporter_thisRef.siblings( '.wbcom_demo_exporter_img').show();
	    	wbcom_demo_exporter_thisRef.siblings( '.wbcom_demo_exporter-remove-file-button').show();
	    });
	...
	$( '.wbcom_demo_exporter-remove-file-button' ).click( function( event ) {
		event.preventDefault();
		$( this ).siblings( '.wbcom_demo_exporter_img_url' ).val( '' );
		$( this ).siblings( '.wbcom_demo_exporter_img').attr( 'src', '' );
	    $( this ).siblings( '.wbcom_demo_exporter_img').hide();
	    $( this ).hide();
	});
